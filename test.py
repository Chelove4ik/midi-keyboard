...
class MyWidget(QMainWindow):
    def __init__(self):
        ...
        self.tm = {self.pushButton_q: [0, QSound(zv_q)], self.pushButton_w: [0, QSound(zv_w)],
                   self.pushButton_e: [0, QSound(zv_e)], self.pushButton_r: [0, QSound(zv_r)],
                   self.pushButton_t: [0, QSound(zv_t)], self.pushButton_y: [0, QSound(zv_y)],
                   self.pushButton_u: [0, QSound(zv_u)], self.pushButton_i: [0, QSound(zv_i)],
                   self.pushButton_o: [0, QSound(zv_o)], self.pushButton_p: [0, QSound(zv_p)],
                   self.pushButton_a: [0, QSound(zv_a)], self.pushButton_s: [0, QSound(zv_s)],
                   self.pushButton_d: [0, QSound(zv_d)], self.pushButton_f: [0, QSound(zv_f)],
                   self.pushButton_g: [0, QSound(zv_g)], self.pushButton_h: [0, QSound(zv_h)],
                   self.pushButton_j: [0, QSound(zv_j)], self.pushButton_k: [0, QSound(zv_k)],
                   self.pushButton_l: [0, QSound(zv_l)], self.pushButton_z: [0, QSound(zv_z)],
                   self.pushButton_x: [0, QSound(zv_x)], self.pushButton_c: [0, QSound(zv_c)],
                   self.pushButton_v: [0, QSound(zv_v)], self.pushButton_b: [0, QSound(zv_b)],
                   self.pushButton_n: [0, QSound(zv_n)], self.pushButton_m: [0, QSound(zv_m)],
                   }
